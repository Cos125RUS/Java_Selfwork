/******************************************************************************
 *  Compilation:  javac Trajectory.java
 *  Execution:    java Trajectory
 *
 *  Interactive program to draw Mandelbrot trajectory.
 *
 ******************************************************************************/
...
public class Trajectory {
    ...
    public static boolean mand(Complex z0, int d) {
        ...
        Complex z = z0;
        StdDraw.filledCircle(z.re(), z.im(), 0.025);
        ...
        for (int t = 0; t < d; t++) {
            ...
            zold = z;
            z = z.times(z).plus(z0);
            StdDraw.filledCircle(z.re(), z.im(), 0.01);
